...
void GuiMenu::openSoundSettings()
{
	...
	s->addWithLabel(Locale::getInstance()->gettext("systemVolume"), volume);
	...
	if (UIModeController::getInstance()->isUIModeFull())
	{
		...
		// audio card
		auto audio_card = std::make_shared< OptionListComponent<std::string> >(mWindow, Locale::getInstance()->gettext("audioCard"), false);
		...
		s->addWithLabel(Locale::getInstance()->gettext("audioCard"), audio_card);
		...
		auto vol_dev = std::make_shared< OptionListComponent<std::string> >(mWindow, Locale::getInstance()->gettext("audioDevice"), false);
		...
		s->addWithLabel(Locale::getInstance()->gettext("audioDevice"), vol_dev);
		...
		s->addWithLabel(Locale::getInstance()->gettext("enableNavigationSounds"), sounds_enabled);
		...
		s->addWithLabel(Locale::getInstance()->gettext("enableVideoAudio"), video_audio);
		s->addSaveFunc([video_audio] { Settings::getInstance()->setBool("VideoAudio", video_audio->getState()); });

#ifdef _OMX_
		// OMX player Audio Device
		auto omx_audio_dev = std::make_shared< OptionListComponent<std::string> >(mWindow, Locale::getInstance()->gettext("omxPlayerAudioDevice"), false);
		...
		s->addWithLabel(Locale::getInstance()->gettext("omxPlayerAudioDevice"), omx_audio_dev);
...
{
	auto s = new GuiSettings(mWindow, Locale::getInstance()->gettext("uiSettings").c_str());

	//Language
	auto language = std::make_shared< OptionListComponent<std::string> >(mWindow, Locale::getInstance()->gettext("language"), false);
	...
	s->addWithLabel(Locale::getInstance()->gettext("language"), language);
	...
	//UI mode
	auto UImodeSelection = std::make_shared< OptionListComponent<std::string> >(mWindow, Locale::getInstance()->gettext("uiMode"), false);
	std::vector<std::string> UImodes = UIModeController::getInstance()->getUIModes();
	for (auto it = UImodes.cbegin(); it != UImodes.cend(); it++)
		UImodeSelection->add(*it, *it, Settings::getInstance()->getString("UIMode") == *it);
	s->addWithLabel(Locale::getInstance()->gettext("uiMode"), UImodeSelection);
	...
	s->addSaveFunc([ UImodeSelection, window]
	{
		...
		if (selectedMode != "Full")
		{
			...
			std::string msg = Locale::getInstance()->gettext("uiModeMsg", {{"selectedMode", selectedMode}, {"formattedPassKeyStr", UIModeController::getInstance()->getFormattedPassKeyStr()}});
	...
	screensaver_row.addElement(std::make_shared<TextComponent>(mWindow, Locale::getInstance()->gettext("screensaverSettings"), Font::get(FONT_SIZE_MEDIUM), 0x777777FF), true);
	...
	s->addWithLabel(Locale::getInstance()->gettext("quickSystemSelect"), quick_sys_select);
	s->addSaveFunc([quick_sys_select] { Settings::getInstance()->setBool("QuickSystemSelect", quick_sys_select->getState()); });

	// carousel transition option
	auto move_carousel = std::make_shared<SwitchComponent>(mWindow);
	move_carousel->setState(Settings::getInstance()->getBool("MoveCarousel"));
	s->addWithLabel(Locale::getInstance()->gettext("carouselTransitions"), move_carousel);
	...
	// transition style
	auto transition_style = std::make_shared< OptionListComponent<std::string> >(mWindow, Locale::getInstance()->gettext("transitionStyle"), false);
	std::vector<std::string> transitions;
	...
	s->addWithLabel(Locale::getInstance()->gettext("transitionStyle"), transition_style);
	...
	if(!themeSets.empty())
	{
		...
		auto theme_set = std::make_shared< OptionListComponent<std::string> >(mWindow, Locale::getInstance()->gettext("themeSet"), false);
		for(auto it = themeSets.cbegin(); it != themeSets.cend(); it++)
			theme_set->add(it->first, it->first, it == selectedSet);
		s->addWithLabel(Locale::getInstance()->gettext("themeSet"), theme_set);
	...
	// GameList view style
	auto gamelist_style = std::make_shared< OptionListComponent<std::string> >(mWindow, Locale::getInstance()->gettext("gamelistViewStyle"), false);
	...
	s->addWithLabel(Locale::getInstance()->gettext("gamelistViewStyle"), gamelist_style);
	...
	s->addWithLabel(Locale::getInstance()->gettext("ignoreArticlesNameSortOnly"), ignore_articles);
	...
	s->addWithLabel(Locale::getInstance()->gettext("useFullScreenPagingForLBRB"), use_fullscreen_paging);
	...
	s->addWithLabel(Locale::getInstance()->gettext("startOnSystem"), systemfocus_list);
	...
	s->addWithLabel(Locale::getInstance()->gettext("onScreenHelp"), show_help);
	s->addSaveFunc([show_help] { Settings::getInstance()->setBool("ShowHelpPrompts", show_help->getState()); });

	// enable filters (ForceDisableFilters)
	auto enable_filter = std::make_shared<SwitchComponent>(mWindow);
	enable_filter->setState(!Settings::getInstance()->getBool("ForceDisableFilters"));
	s->addWithLabel(Locale::getInstance()->gettext("enableFilters"), enable_filter);
	...
	s->addWithLabel(Locale::getInstance()->gettext("disableStartMenuInKidMod"), disable_start);
...
{
	auto s = new GuiSettings(mWindow, Locale::getInstance()->gettext("otherSettings").c_str());

	// maximum vram
	auto max_vram = std::make_shared<SliderComponent>(mWindow, 0.f, 1000.f, 10.f, "Mb");
	max_vram->setValue((float)(Settings::getInstance()->getInt("MaxVRAM")));
	s->addWithLabel(Locale::getInstance()->gettext("vramLimit"), max_vram);
	s->addSaveFunc([max_vram] { Settings::getInstance()->setInt("MaxVRAM", (int)Math::round(max_vram->getValue())); });

	// power saver
	auto power_saver = std::make_shared< OptionListComponent<std::string> >(mWindow, Locale::getInstance()->gettext("powerSaverModes").c_str(), false);
	...
	s->addWithLabel(Locale::getInstance()->gettext("powerSaverModes"), power_saver);
	...
	// gamelists
	auto gamelistsSaveMode = std::make_shared< OptionListComponent<std::string> >(mWindow, Locale::getInstance()->gettext("saveMetadata"), false);
	...
	s->addWithLabel(Locale::getInstance()->gettext("saveMetadata"), gamelistsSaveMode);
	...
	s->addWithLabel(Locale::getInstance()->gettext("parseGameslistsOnly"), parse_gamelists);
	s->addSaveFunc([parse_gamelists] { Settings::getInstance()->setBool("ParseGamelistOnly", parse_gamelists->getState()); });

	auto local_art = std::make_shared<SwitchComponent>(mWindow);
	local_art->setState(Settings::getInstance()->getBool("LocalArt"));
	s->addWithLabel(Locale::getInstance()->gettext("searchForLocalArt"), local_art);
	s->addSaveFunc([local_art] { Settings::getInstance()->setBool("LocalArt", local_art->getState()); });

	// hidden files
	auto hidden_files = std::make_shared<SwitchComponent>(mWindow);
	hidden_files->setState(Settings::getInstance()->getBool("ShowHiddenFiles"));
	s->addWithLabel(Locale::getInstance()->gettext("showHiddenFiles"), hidden_files);
	...
	s->addWithLabel(Locale::getInstance()->gettext("useOmxPlayerHwAccelerated"), omx_player);
	...
	s->addWithLabel(Locale::getInstance()->gettext("indexFilesDuringScreensaver"), background_indexing);
	...
	s->addWithLabel(Locale::getInstance()->gettext("showFramerate"), framerate);
...
{
	Window* window = mWindow;
	window->pushGui(new GuiMsgBox(window, Locale::getInstance()->gettext("configureInputMsg"), Locale::getInstance()->gettext("yes"),
		[window] {
...
{
	auto s = new GuiSettings(mWindow, Locale::getInstance()->gettext("quit").c_str());
	...
	if (UIModeController::getInstance()->isUIModeFull())
	{
		...
		if (confirm_quit) {
			row.makeAcceptInputHandler([window] {
				window->pushGui(new GuiMsgBox(window, Locale::getInstance()->gettext("reallyRestartMsg"), Locale::getInstance()->gettext("yes"), restart_es_fx, Locale::getInstance()->gettext("no"), nullptr));
			});
		} else {
			row.makeAcceptInputHandler(restart_es_fx);
		}
		row.addElement(std::make_shared<TextComponent>(window, Locale::getInstance()->gettext("restartEmulationstation"), Font::get(FONT_SIZE_MEDIUM), 0x777777FF), true);
		s->addRow(row);
		...
		if(Settings::getInstance()->getBool("ShowExit"))
		{
			...
			if (confirm_quit) {
				row.makeAcceptInputHandler([window] {
					window->pushGui(new GuiMsgBox(window, Locale::getInstance()->gettext("reallyQuitMsg"), Locale::getInstance()->gettext("yes"), quit_es_fx, Locale::getInstance()->gettext("no"), nullptr));
				});
			} else {
				row.makeAcceptInputHandler(quit_es_fx);
			}
			row.addElement(std::make_shared<TextComponent>(window, Locale::getInstance()->gettext("quitEmulationstation"), Font::get(FONT_SIZE_MEDIUM), 0x777777FF), true);
			s->addRow(row);
		}
	}
	...
	if (confirm_quit) {
		row.makeAcceptInputHandler([window] {
			window->pushGui(new GuiMsgBox(window, Locale::getInstance()->gettext("reallyRestartMsg"), Locale::getInstance()->gettext("yes"), {reboot_sys_fx}, Locale::getInstance()->gettext("no"), nullptr));
		});
	} else {
		row.makeAcceptInputHandler(reboot_sys_fx);
	}
	row.addElement(std::make_shared<TextComponent>(window, Locale::getInstance()->gettext("restartSystem"), Font::get(FONT_SIZE_MEDIUM), 0x777777FF), true);
	s->addRow(row);
	...
	if (confirm_quit) {
		row.makeAcceptInputHandler([window] {
			window->pushGui(new GuiMsgBox(window, Locale::getInstance()->gettext("reallyShutdownMsg"), Locale::getInstance()->gettext("yes"), shutdown_sys_fx, Locale::getInstance()->gettext("no"), nullptr));
		});
	} else {
		row.makeAcceptInputHandler(shutdown_sys_fx);
	}
	row.addElement(std::make_shared<TextComponent>(window, Locale::getInstance()->gettext("shutdownSystem"), Font::get(FONT_SIZE_MEDIUM), 0x777777FF), true);
	s->addRow(row);
	mWindow->pushGui(s);
}
...
void GuiMenu::openScreensaverOptions() {
	mWindow->pushGui(new GuiGeneralScreensaverOptions(mWindow, Locale::getInstance()->gettext("screensaverSettings").c_str()));
}
